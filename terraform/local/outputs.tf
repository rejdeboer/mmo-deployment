output "kubeconfig_command" {
  description = "Run this command to get kubeconfig file. Should spit out something like: ssh -o StrictHostKeyChecking=no ubuntu@192.168.0.200 'sudo cat /etc/rancher/k3s/k3s.yaml' | sed 's/127.0.0.1/192.168.0.200/' > ~/.kube/config"
